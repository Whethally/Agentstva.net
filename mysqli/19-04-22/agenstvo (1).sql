...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Апр 22 2022 г., 19:53
...
(5, 'assets/img/6.jpg', 'Admin', 'Уфа', 3, '4', '5', '6', '7', '8', 9, 123, 12, '123', 45),
...
--
ALTER TABLE `citys`
  MODIFY `id_city` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
